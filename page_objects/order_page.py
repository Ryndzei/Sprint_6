...
class OrderPage:
    ...
    def set_last_name(self, last_name):
        self.driver.find_element(*OrderPageLocators.SURNAME_INPUT).send_keys(last_name)
    ...
    def set_subway(self, subway_name):
        ...
        return self.driver.find_element(*OrderPageLocators.SUBWAY_HINT_BUTTON(subway_name)).click()
    ...
    def set_date(self, date):
        return self.driver.find_element(*OrderPageLocators.DATE_INPUT).send_keys(date)
    ...
    def set_rent_period(self, option):
        ...
        return self.driver.find_elements(*OrderPageLocators.RENTAL_PERIOD_LIST)[option].click()

    @allure.step('Выбираем нужный цвет')
    def set_colour(self, option):
        return self.driver.find_elements(*OrderPageLocators.COLOR_CHECKBOXES)[option].click()
